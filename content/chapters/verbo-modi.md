...
| | -are | -ere | -ire | -ire (-isc-) |
|---|---|---|---|---|
| che io | parl**i** | vend**a** | dorm**a** | fin**isca** |
| che tu | parl**i** | vend**a** | dorm**a** | fin**isca** |
| che lui/lei | parl**i** | vend**a** | dorm**a** | fin**isca** |
| che noi | parl**iamo** | vend**iamo** | dorm**iamo** | fin**iamo** |
| che voi | parl**iate** | vend**iate** | dorm**iate** | fin**iate** |
| che loro | parl**ino** | vend**ano** | dorm**ano** | fin**iscano** |

Le tre persone del singolare sono **identiche**: nel parlato, il pronome soggetto (di solito omesso altrove) spesso ricompare al congiuntivo solo per disambiguare (*che **io** parta*, non *che parta* da solo).

### Congiuntivi irregolari più comuni
...
| | -are | -ere | -ire |
|---|---|---|---|
| che io | parl**assi** | vend**essi** | dorm**issi** |
| che tu | parl**assi** | vend**essi** | dorm**issi** |
| che lui/lei | parl**asse** | vend**esse** | dorm**isse** |
| che noi | parl**assimo** | vend**essimo** | dorm**issimo** |
| che voi | parl**aste** | vend**este** | dorm**iste** |
| che loro | parl**assero** | vend**essero** | dorm**issero** |

**essere** → fossi, fossi, fosse, fossimo, foste, fossero. Congiuntivo passato e trapassato si formano con **avere/essere** al congiuntivo presente/imperfetto + participio: *che io **abbia** parlato, che io **avessi** parlato*.
...
Stesso radicale del futuro (comprese le irregolarità), desinenze proprie:

| | -are/-ere | -ire |
|---|---|---|
| io | parler**ei** | dormir**ei** |
| tu | parler**esti** | dormir**esti** |
| lui/lei | parler**ebbe** | dormir**ebbe** |
| noi | parler**emmo** | dormir**emmo** |
...
|---|---|---|---|---|
| (tu) | parl**a** | vend**i** | dorm**i** | fin**isci** |
| (Lei) | parl**i** | vend**a** | dorm**a** | fin**isca** |
